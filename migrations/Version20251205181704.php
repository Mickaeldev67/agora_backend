 ...
 */
final class Version20251205181704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_9D40DE1B9777D11E ON topic');
        $this->addSql('ALTER TABLE topic CHANGE category_id_id category_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE topic CHANGE category_id category_id_id INT NOT NULL');
        $this->addSql('CREATE INDEX IDX_9D40DE1B9777D11E ON topic (category_id_id)');
    }
}
