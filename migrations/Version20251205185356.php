 ...
 */
final class Version20251205185356 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_community (user_id INT NOT NULL, community_id INT NOT NULL, INDEX IDX_1B80CDD7A76ED395 (user_id), INDEX IDX_1B80CDD7FDA7B0BF (community_id), PRIMARY KEY (user_id, community_id)) DEFAULT CHARACTER SET utf8mb4');
