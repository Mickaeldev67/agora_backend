 ...
 */
final class Version20251207113459 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_community (id INT AUTO_INCREMENT NOT NULL, is_favorite TINYINT NOT NULL, user_id INT DEFAULT NULL, community_id INT NOT NULL, INDEX IDX_1B80CDD7A76ED395 (user_id), INDEX IDX_1B80CDD7FDA7B0BF (community_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE user_community ADD CONSTRAINT FK_1B80CDD7A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE user_community ADD CONSTRAINT FK_1B80CDD7FDA7B0BF FOREIGN KEY (community_id) REFERENCES community (id)');
        ...
        $this->addSql('ALTER TABLE thread ADD CONSTRAINT FK_31204C83FDA7B0BF FOREIGN KEY (community_id) REFERENCES community (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_community DROP FOREIGN KEY FK_1B80CDD7A76ED395');
        $this->addSql('ALTER TABLE user_community DROP FOREIGN KEY FK_1B80CDD7FDA7B0BF');
        $this->addSql('DROP TABLE user_community');
        ...
        $this->addSql('ALTER TABLE thread DROP FOREIGN KEY FK_31204C83FDA7B0BF');
