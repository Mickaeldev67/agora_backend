 ...
 */
final class Version20251206164045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE thread ADD community_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE user_community ADD CONSTRAINT FK_1B80CDD7A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE user_community ADD CONSTRAINT FK_1B80CDD7FDA7B0BF FOREIGN KEY (community_id) REFERENCES community (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_31204C83FDA7B0BF ON thread');
        $this->addSql('ALTER TABLE thread DROP community_id');
